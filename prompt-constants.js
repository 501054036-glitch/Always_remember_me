...
export function getNovelWriteSystemPrompt(options) {
    ...
    const mergedGraph = (typeof window !== 'undefined' && window.extension_settings?.always_remember_me?.mergedGraph) || null;
    const styleGuidelines = extractStyleGuidelines(mergedGraph);
